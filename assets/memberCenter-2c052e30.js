import{e as n,i as Q,a as Ce,j as s,s as f,d as X}from"./config-899afede.js";import"./userLogOut-da953201.js";import"./hamMenu-6b7faa69.js";import c from"https://cdnjs.cloudflare.com/ajax/libs/axios/1.5.1/esm/axios.js";(function(){var e=document.querySelectorAll(".needs-validation");Array.prototype.slice.call(e).forEach(function(t){t.addEventListener("submit",function(a){t.checkValidity()||(a.preventDefault(),a.stopPropagation()),t.classList.add("was-validated")},!1)})})();const x=location.href.split("=")[1],ne=document.querySelector(".js-memberInfo"),te=document.querySelector(".js-editName"),q=document.querySelector(".js-editPhone"),M=document.querySelector(".js-editEmail"),g=document.querySelector(".js-editPassword");async function oe(){try{let t=(await c.get(`${s}/660/users/${x}`,{headers:{authorization:`Bearer ${localStorage.getItem("userToken")}`}})).data;qe(t)}catch(e){throw new Error(e)}}oe().catch(e=>{n(e)});function qe(e){ne.innerHTML=`
        <p class="fs-4">會員資訊
    ...
    `}function Re(e){let t=ge(e);re.insertAdjacentHTML("beforebegin",t)}function Fe(e){let t=he(e);Z.insertAdjacentHTML("beforeend",t),X.update()}function Ve(e){let t="";e.forEach(a=>{t+=ge(a)}),re.insertAdjacentHTML("beforebegin",t),X.update()}function Oe(e){let t="";e.forEach(a=>{t+=he(a)}),Z.innerHTML=t}Z.addEventListener("click",_e);function _e(e){if(e.target.classList.contains("js-editModalBtn"))Ue(e);else if(e.target.classList.contains("js-deleteSlideBtn"))Ge(e);else if(e.target.classList.contains("js-uploadImg")){let t=e.target.getAttribute("data-id"),a=document.querySelector(`#dogImg_uploads${t}`);a&&a.addEventListener("change",function(){Ke(a,t)})}else if(e.target.classList.contains("js-clearDogImg")){e.preventDefault();let t=e.target.getAttribute("data-id"),a=document.querySelector(`.js-dogImgView${t}`),o=document.querySelector(`.js-dogImg${t}`);for(;a.firstChild;)a.removeChild(a.firstChild);let r=document.createElement("p");for(r.textContent="請選擇照片",r.className="mb-0",a.appendChild(r),localStorage.removeItem(`dogImg${t}`),document.querySelector(`#dogImg_uploads${t}`).value="";o.firstChild;)o.removeChild(o.firstChild);c.patch(`${s}/660/dogs/${t}`,{dogImg:""},{headers:{authorization:`Bearer ${localStorage.getItem("userToken")}`}}).then(l=>{l.data}).catch(l=>{console.log(l)})}}function Ue(e){e.preventDefault();const t=e.target.closest(".dogModalForm");if(t.checkValidity())We(e);else{e.stopPropagation(),t.classList.add("was-validated");return}}async function We(e){try{let t=e.target.getAttribute("data-id"),a=document.querySelector(`.js-editDogName${t}`),o=document.querySelector(`.js-editDogBreed${t}`),r=document.querySelector(`.js-editDogAge${t}`),i=(await c.get(`${s}/660/dogs/${t}`,{headers:{authorization:`Bearer ${localStorage.getItem("userToken")}`}})).data;if(a.value.trim()===i.name&&o.value.trim()===i.breed&&r.value.trim()===i.age){n("毛孩資訊無變更！");return}else c.patch(`${s}/660/dogs/${t}`,{name:a.value,breed:o.value,age:r.value},{headers:{authorization:`Bearer ${localStorage.getItem("userToken")}`}}).then(d=>{let u=d.data,je=document.querySelector(`.swiper-slide[data-id="${t}"]`);Ye(je,u),f("成功更新資訊卡！","",3e3)}).catch(d=>{throw new Error(d)})}catch(t){console.log(t),n("更新資訊卡失敗！")}}function Ye(e,t){if(e){let a=localStorage.getItem(`dogImg${t.id}`);e.innerHTML=`
            <ul
    ...
    `}),Z.innerHTML=t}$(function(){$.datepicker.regional["zh-TW"]={dayNames:["星期日","星期一","星期二","星期三","星期四","星期五","星期六"],dayNamesMin:["日","一","二","三","四","五","六"],monthNames:["一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"],monthNamesShort:["一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"],prevText:"上月",nextText:"次月",weekHeader:"週"},$.datepicker.setDefaults($.datepicker.regional["zh-TW"]),$(function(){$(".datepicker").datepicker({beforeShow:function(e,t){t.dpDiv.addClass("custom-datepicker")},dateFormat:"yy-mm-dd",minDate:1,maxDate:"+3M",onSelect:function(e,t){}}),$(".startDate").datepicker({beforeShow:function(e,t){t.dpDiv.addClass("custom-datepicker")},dateFormat:"yy-mm-dd",minDate:1,maxDate:"+3M",onSelect:function(e,t){const a=new Date(e),o=new Date($(".endDate").val());o&&(a>o?(n("入住日期不能大於退房日期！","請重新選擇日期"),$(".startDate").val("")):a.getDate()===o.getDate()&&a.getMonth()===o.getMonth()&&a.getFullYear()===o.getFullYear()&&(n("入住日期不能與退房日期相同！","請重新選擇日期"),$(".startDate").val("")))}}),$(".endDate").datepicker({beforeShow:function(e,t){t.dpDiv.addClass("custom-datepicker")},dateFormat:"yy-mm-dd",minDate:1,maxDate:"+3M",onSelect:function(e,t){const a=new Date(e),o=new Date($(".startDate").val());o&&(o>a?(n("退房日期不能小於入住日期！","請重新選擇日期"),$(".endDate").val("")):o.getDate()===a.getDate()&&o.getMonth()===a.getMonth()&&o.getFullYear()===a.getFullYear()&&(n("入住日期不能與退房日期相同！","請重新選擇日期"),$(".endDate").val("")))}})})});$(".startDate").on("change",function(e){const t=e.target.value;if(t){const a=new Date(t),o=new Date($(".endDate").val());o&&a>o?(n("入住日期不能大於退房日期！","請重新選擇日期"),$(".startDate").val("")):o&&a.getTime()===o.getTime()&&(n("入住日期不能與退房日期相同！","請重新選擇日期"),$(".startDate").val(""))}});$(".endDate").on("change",function(e){const t=e.target.value;if(t){const a=new Date(t),o=new Date($(".startDate").val());o&&o>a?(n("退房日期不能小於入住日期！","請重新選擇日期"),$(".endDate").val("")):o&&o.getTime()===a.getTime()&&(n("入住日期不能與退房日期相同！","請重新選擇日期"),$(".endDate").val(""))}});$(document).ready(function(){$(".timepicker").timepicker({timeFormat:"h:i A",step:60,minTime:"9:00",maxTime:"21:00",startTime:"9:00",dynamic:!0}),$(".timepicker").on("changeTime",function(){$(this).val()})});(function(){var e=document.querySelectorAll(".needs-validation");Array.prototype.slice.call(e).forEach(function(t){t.addEventListener("submit",function(a){t.checkValidity()||(a.preventDefault(),a.stopPropagation()),t.classList.add("was-validated")},!1)})})();const ee=location.href.split("=")[1],le=document.querySelector(".js-dayCareRecord"),ie=document.querySelector(".js-cosmeticRecord"),de=document.querySelector(".js-stayRecord"),fe=document.querySelector(".js-historyDayCare"),pe=document.querySelector(".js-historyCosmetic"),ve=document.querySelector(".js-historyStay");function I(){c.get(`${s}/660/reverse?userId=${ee}`,{headers:{authorization:`Bearer ${localStorage.getItem("userToken")}`}}).then(e=>{if(e){let t=e.data,a=t.filter(r=>r.isChecked===!1),o=t.filter(r=>r.isChecked===!0);ye(a),$e(o)}}).catch(e=>{console.log(e)})}I();function ye(e){let t="",a="",o="";e.forEach(r=>{r.service==="安親"?(t=`
        ...
        `+t,le.innerHTML=t):r.service==="美容"?(a=`
            ...
            `+o,de.innerHTML=o)})}function $e(e){let t="",a="",o="";e.forEach(r=>{r.service==="安親"?(t=`
            <tr>
        ...
        `+t,fe.innerHTML=t):r.service==="美容"?(a=`
            ...
            `+a,pe.innerHTML=a):r.service==="住宿"&&(o=`
                <tr>
                    <th scope="row">${r.orderNum}</th>
                    <td>${r.dogName}</td>
                    <td>${r.room}</td>
